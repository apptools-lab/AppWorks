...
1. Use materials in JSX files (such as View). [How to use materials?](https://marketplace.visualstudio.com/items?itemName=iceworks-team.iceworks-component-builder)
